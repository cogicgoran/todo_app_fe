...
function PasswordResetLogin(): JSX.Element {
    ...
    const onSubmit = useOnSubmit(customFetch, setError, setCurrentUser, token);
        ...
        <div className="auth-page">
            <form className="form" onSubmit={handleSubmit(onSubmit)} onChange={() => clearAllErrors()}>
                <div className='form__input-field'>
                    ...
                    })} placeholder="email-reset" autoComplete="off" />
...
export default PasswordResetLogin;